...
$(document).ready(function(){
    $(".buttons .login").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Login_Page.html"
        window.scrollTo(0, 0)
    })

    $(".buttons .signup").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Registration_Page.html"
        window.scrollTo(0, 0)
    })

    $(".goToStudent").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Student_Dashboard.html"
        window.scrollTo(0, 0)
    })

    $(".goToTeacher").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Teacher_Dashboard.html"
        window.scrollTo(0, 0)
    })

    $(".enrollBtn").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Exam_Enrollment.html"
        window.scrollTo(0, 0)
    })

    $(".enrollInTheExam").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Live_Exam.html"
        window.scrollTo(0, 0)
    })

    $(".submitTheExam").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Exam_Submition.html"
        window.scrollTo(0, 0)
    })

    $(".addNewExam").click(function(e){
        e.preventDefault()
        document.location.href = "Examination-System-Project/Pages/Exam_Creation_Info.html"
        window.scrollTo(0, 0)
    })
